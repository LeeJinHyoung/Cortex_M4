...
int main()
{
  ...
  GPIO_InitStructure_led.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_2|GPIO_Pin_3|
...
void Serial_Send(unsigned char t)
{
  ...
  while (USART_GetFlagStatus(USART1, USARTujhjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjhjiFLAG_TXE) == RESET);
}
